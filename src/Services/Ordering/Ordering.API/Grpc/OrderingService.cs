...
using Ordering.API.Proto;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;
using WWGRS.BuildingBlocks.EventBuses.Extensions;
using static Ordering.API.Proto.OrderingGrpc;

namespace WWGRS.Service.Ordering.API.Grpc
{
    public class OrderingService : OrderingGrpcBase
    {
        ...
        public override async Task<OrderDraftDTO> CreateOrderDraftFromBasketData(CreateOrderDraftCommand createOrderDraftCommand, ServerCallContext context)
        {
            ...
            var command = new Applicaiton.Commands.CreateOrderDraftCommand(
                            createOrderDraftCommand.BuyerId,
        ...
        public OrderDraftDTO MapResponse(Applicaiton.Models.OrderDraftDTO order)
        {
        ...
        public IEnumerable<Applicaiton.Models.BasketItem> MapBasketItems(RepeatedField<BasketItem> items)
        {
            return items.Select(x => new Applicaiton.Models.BasketItem()
            {
                Id = x.Id,
