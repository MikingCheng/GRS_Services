...
using WWGRS.Service.Ordering.API.Infrastructure;
    ...
    public class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                var host = CreateHostBuilder(configuration, args);                                 // BuildWebHost(configuration, args);

                host.Build().MigrateDbContext<OrderingContext>((context, services) =>
                {
